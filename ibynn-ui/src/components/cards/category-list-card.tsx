...
const CategoryListCard: React.FC<Props> = ({
  ...
  return (
    <>
      <div className='flex items-center justify-around flex-col shadow-xl border-solid border-2 border-gray-400 rounded-lg' onClick={onClick} style={{width: '100%', minHeight: '125px', cursor: 'pointer', margin: '5px', padding: '10px'}}>
            <span className="text-15px text-brand-dark capitalize">
              {name}
            </span>
            <div
